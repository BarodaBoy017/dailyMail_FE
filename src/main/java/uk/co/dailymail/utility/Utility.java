package uk.co.dailymail.utility;
...
import uk.co.dailymail.drivermanager.ManageDriver;
...
//***************************** Is Display Methods **********************************************//
    ...
    public static void takeScreenShot() {
        String filePath = System.getProperty("user.dir") + "/src/main/java/uk/co/dailymail/screenshot/";
    ...
    public String currentHour() {
        SimpleDateFormat formatterH = new SimpleDateFormat("h");
        Date dateH = new Date(System.currentTimeMillis());

      //  System.out.println("Current Hour = " + formatterH.format(dateH));
        return formatterH.format(dateH);
    }

    public static String currentDate() throws ParseException {
        SimpleDateFormat formatter = new SimpleDateFormat("EEEE, MMM dd'th' yyyy");
    ...
    public static String getScreenshot(WebDriver driver, String screenshotName) {
        ...
        String destination = System.getProperty("user.dir") + "src/main/java/uk/co/dailymail/testReport/" + screenshotName + dateName + ".png";
